...
$_LANG["addfunds"] = "Guthaben / Vorauszahlung hinzufüge";
...
$_LANG["addtocart"] = "Zum Warenkorb hinzufüge";
...
$_LANG["affiliatesdescription"] = "Klicken Sie hier, um Vermittlungspartner (Affiliate) zu werden, oder um Ihre Einkünfte zu sehe";
...
$_LANG["affiliatesfootertext"] = "Wenn Sie jemanden mit Ihrer einzigartigen Vermittlungs-ID an unsere Webseite weiterleiten, wird auf diesem Computer ein Cookie mit der Vermittlungs-ID abgelegt. Wenn dieser Besucher später zurückkehrt und eine Dienstleistung bucht erhalten Sie die Kommission ebenfal";
...
$_LANG["affiliatesrequestwithdrawal"] = "Überweisungsauftra";
...
$_LANG["affiliateswithdrawalrequestsuccessful"] = "Ihr Überweisungsauftrag wurde übermittelt. Sie werden in Kürze kontaktie";
$_LANG["affiliateswithdrawn"] = "Insgesamt abgehobener Betrag";
$_LANG["all"] = "Alle";
$_LANG["alreadyregistered"] = "Sind Sie bereits Kunde?";
$_LANG["announcementsdescription"] = "Neuigkeiten und Ankündigunge";
$_LANG["announcementsnone"] = "Es gibt keine Ankündigunge";
$_LANG["announcementsrss"] = "RSS Feed anzeigen";
$_LANG["announcementstitle"] = "Ankündigunge";
...
$_LANG["cartconfigoptionsdesc"] = "Bei diesem Produkt gibt es weitere Optionen zur Konfiguration. Bitte wählen Sie die Option aus, die Sie hinzufügen möcht";
$_LANG["cartconfigserver"] = "Server konfigurieren";
$_LANG["cartcustomfieldsdesc"] = "Für dieses Produkt benötigen wir weitere Informationen zur Ausführung des Auftrag";
$_LANG["cartdomainsconfig"] = "Domainkonfiguration";
$_LANG["cartdomainsconfigdesc"] = "Hier können Sie ihre Domainkonfiguration vornehmen, Erweiterungen hinzufügen und benötigte Informationen eingeb";
...
$_LANG["cartnameserversdesc"] = "Wenn Sie eigene Nameserver benutzen möchten geben Sie diese bitte hier an. Standardmäßig stellen wir unsere Nameserver zur Verfüg";
$_LANG["cartproductaddons"] = "Zusatzpakete / Produkterweiterungen";
$_LANG["cartproductaddonschoosepackage"] = "Produktauswahl";
$_LANG["cartproductaddonsnone"] = "Keine Erweiterung für das gewählte Produkt verfügb";
...
$_LANG["cartproductdomainchoose"] = "Bitte auswähle";
$_LANG["cartproductdomaindesc"] = "Das von Ihnen gewählte Produkt erfordert die Registrierung eines Domainnamens. Bitte wählen Sie eine Optio";
...
$_LANG["checkavailability"] = "Verfügbarkeit prüf";
$_LANG["checkout"] = "zur Kasse";
$_LANG["choosecurrency"] = "Währung auswählen";
$_LANG["choosedomains"] = "Domains auswähle";
...
$_LANG["clientareaaddfundsnotallowed"] = "Sie benötigen mindestens eine aktive Bestellung um ein Guthaben hinzuzufüge";
$_LANG["clientareaaddon"] = "Zusatzpaket";
$_LANG["clientareaaddonorderconfirmation"] = "Vielen Dank. Das untenstehende Zusatzpaket wurde zur Bestellung hinzugefügt. Bitte wählen Sie nun die gewünschte Zahlungsmeth";
$_LANG["clientareaaddonpricing"] = "Preise";
$_LANG["clientareaaddonsfor"] = "Zusatzpakete fü";
...
$_LANG["clientareacancel"] = "Kundenaccount lösche";
$_LANG["clientareacancelconfirmation"] = "Vielen Dank. Der Stornierungsauftrag wurde übermittelt. Falls Sie diesen Auftrag aus Versehen geschickt haben, senden Sie uns bitte umgehend ein Supportticket, bevor wir Ihren Account lösche";
...
$_LANG["clientareadeletecontact"] = "Kontakt lösche";
$_LANG["clientareadeletecontactareyousure"] = "Diesen Kontakt wirklich löschen";
$_LANG["clientareadescription"] = "Klicken Sie hier um Ihr Profil zu ändern, Rechnungsinformationen anzuzeigen und zusätzliche Dienstleistungen zu bestell";
...
$_LANG["clientareaemailsintrotext"] = "Unten finden Sie den Verlauf aller Nachrichten, die wir an Sie geschickt haben. Sie können bequem die gesamte Korrespondenz anzeigen, falls Sie unsere Emails nicht mehr zur Verfügung habe";
...
$_LANG["clientareaerrorcountry"] = "Bitte wählen Sie Ihr Land aus der Auswahllist";
$_LANG["clientareaerroremail"] = "Sie haben keine Emailadresse eingegeben";
$_LANG["clientareaerroremailinvalid"] = "Die angegebene Emailadresse ist ungülti";
...
$_LANG["clientareaerrorpasswordconfirm"] = "Sie haben das Passwort nicht bestätig";
$_LANG["clientareaerrorpasswordnotmatch"] = "Die Passwortbestätigung ist nicht gleich wie das Passwor";
...
$_LANG["clientareaheader"] = "Willkommen in unserem Kundencenter. Hier können Sie Ihre persönlichen Daten anzeigen und aktualisieren, Ihre Hostingaccounts und Domains anzeigen, Supportanfragen absenden und zusätzliche Produkte & Dienstleistungen bestell";
...
$_LANG["clientarealeaveblank"] = "Leer lassen, außer Sie möchten Ihr Passwort änd";
$_LANG["clientareamodifydomaincontactinfo"] = "Domain-Kontaktinformation änder";
$_LANG["clientareamodifynameservers"] = "Nameserver änder";
$_LANG["clientareamodifywhoisinfo"] = "WHOIS Kontaktinformationen änder";
$_LANG["clientareanameserver"] = "Nameserver";
$_LANG["clientareanavaddcontact"] = "Kontakt hinzufüge";
$_LANG["clientareanavchangecc"] = "Kreditkartendetails anpassen";
$_LANG["clientareanavchangepw"] = "Passwort änder";
...
$_LANG["clientareanavsecurityquestions"] = "Sicherheitsfrage änder";
...
$_LANG["clientareasavechanges"] = "Änderungen speicher";
$_LANG["clientareasecurityanswer"] = "Bitte geben Sie eine Antwort ein";
$_LANG["clientareasecurityconfanswer"] = "Bitte bestätigen Sie Ihre Antwor";
$_LANG["clientareasecurityquestion"] = "Bitte wählen Sie eine Sicherheitsfrag";
$_LANG["clientareaselectcountry"] = "Land auswähle";
...
$_LANG["clientareaupdateyourdetails"] = "Persönliche Daten ände";
$_LANG["clientareaused"] = "Verbraucht";
$_LANG["clientareaviewaddons"] = "Mögliche Zusatzpakete / Optionen anzeige";
...
$_LANG["clientregisterheadertext"] = "Um ein neues Konto zu eröffnen füllen Sie bitte nachstehendes Formular aus. Die benötigten Felder sind mit * markie";
$_LANG["clientregistertitle"] = "Registrieren";
$_LANG["clientregisterverify"] = "Registrierung überprüf";
...
$_LANG["closewindow"] = "Fenster schließe";
$_LANG["completeorder"] = "Bestellung abschließe";
$_LANG["confirmnewpassword"] = "Neues Passwort bestätige";
...
$_LANG["contactheader"] = "Um uns zu kontaktieren füllen Sie bitte nachstehendes Formular au";
...
$_LANG["creditcard3dsecure"] = "Als Teil unserer Sicherheitsvorkehrungen gegen Mißbrauch werden Sie nun gebeten, Ihre 'Verified by Visa' oder 'Mastercard SecureCode' Identifikation durchzuführen, sofern Sie für diese Dienste freigeschaltet si";
...
$_LANG["creditcardccvinvalid"] = "Der Kartensicherheitscode ist ungülti";
$_LANG["creditcardconfirmation"] = "Vielen Dank! Ihre Kreditkartenzahlung wurde akzeptiert und Ihre Karte mit dem Betrag belastet. Sie erhalten in Kürze eine Bestätigung per Emai";
...
$_LANG["creditcardnumberinvalid"] = "Die Kreditkartennummer wie von Ihnen eingegeben ist ungülti";
$_LANG["creditcardsecuritynotice"] = "Um Risiken zu minimieren findet die Datenübermittlung an das Kreditinstitut verschlüsselt stat";
$_LANG["creditcarduseexisting"] = "Existierende Kreditkarte verwenden";
$_LANG["customfieldvalidationerror"] = "Wert ist ungülti";
$_LANG["days"] = "Tage";
$_LANG["defaultbillingcontact"] = "Rechnungsempfänge";
...
$_LANG["domaincheckerdescription"] = "Überprüfen der Verfügbarkeit einer Dom";
...
$_LANG["domaindnsmanagementdesc"] = "Leiten Sie Ihre Domain auf eine Webseite weiter, indem Sie auf die IP-Adresse verweisen, oder leiten Sie sie auf eine andere Seite weiter, oder leiten Sie sie auf eine temporäre Seite weiter (bekannt als 'Domain Parking'), und mehr. Diese Einträge sind auch bekannt als Subdomain";
$_LANG["domaindnsrecordtype"] = "Registrierungstyp";
$_LANG["domainemailforwarding"] = "Email-Weiterleitung";
$_LANG["domainemailforwardingdesc"] = "Wenn der weiterleitende Emailserver feststellt, dass die anzusprechende Emailadresse ungültig ist, so werden wir den Weiterleitungseintrag automatisch deaktivieren. Bitte prüfen Sie die Emailadresse, auf die weitergeleitet werden soll, bevor Sie sie wieder aktivieren. Die Änderungen an bestehenden Weiterleitungseinträgen werden nicht in unter einer Stunde wirksam s";
...
$_LANG["domainerrornodomain"] = "Bitte geben Sie einen gültigen Domainnamen ei";
...
$_LANG["domaingeteppcodeexplanation"] = "Der EPP/Authcode ist kurz gesagt ein Passwort für eine Domain. Dies stellt sicher dass nur der Inhaber der Domain diese auch umziehen kann. Sie benötigen den EPP/Authcode zum Provider-Transfe";
$_LANG["domaingeteppcodefailure"] = "Fehler bei der Anfrage des EPP/Authcode:";
$_LANG["domaingeteppcodeis"] = "EPP/Authcode lautet:";
$_LANG["domainidprotection"] = "Identitätsschut";
$_LANG["domainintrotext"] = "Geben Sie bitte den zu suchenden Domainnamen an und klicken Sie 'Suchen', um zu prüfen ob die gewünschte Domain noch frei is";
...
$_LANG["domainregisternsmod"] = "Nameserver-IP änder";
...
$_LANG["domainregistrantchoose"] = "Bitte wählen Sie den zu benutzenden Kontak";
...
$_LANG["domainrenew"] = "Domain verlänger";
$_LANG["domainrenewal"] = "Domain Verlängerun";
$_LANG["domainrenewalprice"] = "Erneuerung";
$_LANG["domainrenewdesc"] = "Tipp: Sichern Sie sich Ihre Domain gleich für mehrere Jahre";
$_LANG["domainsautorenew"] = "automatische Verlängerun";
$_LANG["domainsautorenewdisable"] = "automatische Verlängerung deaktiviere";
$_LANG["domainsautorenewdisabled"] = "Deaktiviert";
$_LANG["domainsautorenewdisabledwarning"] = "Die automatische Verlängerung ist deaktiviert. Sofern die Domain nicht manuell verlängert wird, wird diese am Ende der Laufzeit freigegebe";
$_LANG["domainsautorenewenable"] = "automatische Verlängerung aktiviere";
...
$_LANG["downloadpurchaserequired"] = "Zugriff verweigert! Für den Download müssen Sie das dazugehörige Produkt erwerb";
$_LANG["downloadscategories"] = "Kategorien";
$_LANG["downloadsdescription"] = "Downloads";
$_LANG["downloadsfiles"] = "Dateien";
$_LANG["downloadsfilesize"] = "Dateigrö�";
$_LANG["downloadsintrotext"] = "In der Downloadbibliothek finden Sie Dokumente & Software, die für Sie nützlich sein könnt";
...
$_LANG["firstpaymentamount"] = "Betrag für die erste Zahlun";
...
$_LANG["flashtutorialsheadertext"] = "Unsere Flashtutorials sind hier, um Ihnen bei der Nutzung des Hosting-Controlpanels zu helfen. Wählen Sie eines der unten stehenden Schritt-für-Schritt-Tutorials, um die entsprechende Aufgabe zu bewältig";
...
$_LANG["invoiceaddcreditdesc2"] = "Sie können dies über untenstehendes Formular einer Rechnung zuweise";
...
$_LANG["invoiceofflinepaid"] = "Offline Kreditkartenzahlungen werden manuell ausgeführt. Sie erhalten eine Bestätigung per Email, sobald die Zahlung erledigt is";
$_LANG["invoicerefnum"] = "Vorgangsnummer";
$_LANG["invoices"] = "Rechnungen";
$_LANG["invoicesamount"] = "Betrag";
$_LANG["invoicesattn"] = "z.H.";
$_LANG["invoicesbacktoclientarea"] = "<< Zurück zum Kundenzentru";
...
$_LANG["invoicesdatedue"] = "Fälligkeitsdatu";
$_LANG["invoicesdescription"] = "Beschreibung";
$_LANG["invoicesdownload"] = "Vollständige PDF-Rechnung anzeige";
$_LANG["invoicesdue"] = "Fällige Rechnunge";
...
$_LANG["invoicestransnonefound"] = "Keine zugehörige Transaktion gefunde";
...
$_LANG["knowledgebasefavorites"] = "Zu Favoriten hinzufüge";
...
$_LANG["knowledgebasepopular"] = "Populärst";
...
$_LANG["latefee"] = "Mahngebüh";
$_LANG["latefeeadded"] = "hinzugefüg";
$_LANG["latestannouncements"] = "Letzte Ankündigunge";
...
$_LANG["maxmind_anonproxy"] = "Wir erlauben keine Bestellungen über anonyme Proxy";
$_LANG["maxmind_callingnow"] = "Wir rufen nun die von Ihnen angegebene Telefonnummer an. Das ist Teil unseres Sicherheitssystems. Sie erhalten am Telefon einen vierstelligen Sicherheitscode den Sie unten eingeben müssen, um die Bestellung abzuschließe";
$_LANG["maxmind_countrymismatch"] = "Die IP-Adresse Ihres Landes stimmt nicht mit der IP der Rechnungsadresse überein. Wir können Ihre Bestellung leider nicht akzeptier";
$_LANG["maxmind_error"] = "Fehler";
$_LANG["maxmind_faileddescription"] = "Der eingegebene Code ist falsch. Falls es sich dabei um einen Systemfehler handelt, füllen Sie bitte ein Supportticket au";
$_LANG["maxmind_highfraudriskscore"] = "Unser System hat ein hohes Risiko für diese Bestellung ermittelt und den Vorgang abgebroche";
$_LANG["maxmind_highriskcountry"] = "Wir akzeptieren keine Bestellungen aus Ihrem Land, weil das Risiko für Mißbrauch zu hoch i";
...
$_LANG["networkissuespriority"] = "Prioritä";
...
$_LANG["nextpage"] = "Nächste Seit";
$_LANG["no"] = "Nein";
$_LANG["nocarddetails"] = "Keine bestehenden Kartendetails gefunden";
$_LANG["none"] = "Keine";
$_LANG["norecordsfound"] = "Keine Aufzeichnung gefunden";
$_LANG["or"] = "or";
$_LANG["orderadditionalrequiredinfo"] = "Zusätzlich benötigte Angab";
$_LANG["orderaddon"] = "Zusatzpaket / Option";
$_LANG["orderaddondescription"] = "Die folgenden Zusatzpakete / Optionen sind zu diesem Produkt erhältlich. Bitte wählen Sie die Option aus, die Sie hinzufügen möch";
$_LANG["orderavailable"] = "Erhältlic";
$_LANG["orderavailableaddons"] = "Klicken Sie hier um mögliche Zusatzpakete / Optionen einzusehe";
$_LANG["orderbillingcycle"] = "Verrechnungszyklus";
$_LANG["ordercategories"] = "Kategorien";
$_LANG["orderchangeaddons"] = "Zusatzpakete änder";
$_LANG["orderchangeconfig"] = "Konfigurierbare Optionen änder";
$_LANG["orderchangedomain"] = "Domain änder";
$_LANG["orderchangenameservers"] = "Nur DNS Nameserver änder";
$_LANG["orderchangeproduct"] = "Produkt änder";
$_LANG["ordercheckout"] = "zur Kasse";
$_LANG["orderchooseaddons"] = "Wählen Sie Produkt-Zusatzpakete / -Optione";
...
$_LANG["orderconfirmation"] = "Bestellungsbestätigun";
$_LANG["orderconfirmorder"] = "Bestellung bestätige";
...
$_LANG["orderdomainoption3"] = "Ich möchte meine Domain transferieren z";
...
$_LANG["ordererroraccepttos"] = "Sie müssen die allgemeinen Vertragsbedingungen (AGB) akzeptiere";
$_LANG["ordererrordomainalreadyexists"] = "Die Domain, die Sie eingegeben haben, ist bereits bei uns registriert. Sie müssen den Auftrag vorher abbrechen, bevor Sie eine neue Bestellung durchführen könn";
$_LANG["ordererrordomaininvalid"] = "Die eingegebene Domain ist ungülti";
$_LANG["ordererrordomainnotld"] = "Sie müssen eine Domainendung (TLD) angebe";
$_LANG["ordererrordomainnotregistered"] = "Sie können keine Domain transferieren, die nicht bereits registriert is";
$_LANG["ordererrordomainregistered"] = "Die eingegebene Domain ist bereits registriert";
$_LANG["ordererrornameserver1"] = "Sie müssen Nameserver 1 eingebe";
$_LANG["ordererrornameserver2"] = "Sie müssen Nameserver 2 eingebe";
...
$_LANG["ordererrorservernohostname"] = "Sie müssen einen Hostnamen für Ihren Server eingeb";
$_LANG["ordererrorservernonameservers"] = "Sie müssen einen Prefix für beide Nameserver eingeb";
$_LANG["ordererrorservernorootpw"] = "Sie müssen das gewünschte Root-Passwort eingeb";
$_LANG["ordererrorsubdomaintaken"] = "Die Subdomain ist bereits vergeben. Bitte versuchen Sie es erneut.";
$_LANG["ordererrortransfersecret"] = "Sie müssen einen Transferschlüssel (Transfer Secret) eingeb";
$_LANG["ordererroruserexists"] = "Ein Kunde mit dieser Emailadresse existiert bereits";
$_LANG["orderexistinguser"] = "Ich bin bereits Kunde und möchte diese Bestellung zu meinem Konto hinzufüg";
$_LANG["orderfailed"] = "Bestellungsfehler";
$_LANG["orderfinalinstructions"] = "Wenn Sie Fragen zu Ihrer Bestellung haben, füllen Sie bitte ein Supportticket im Kudenzentrum aus und fügen Sie bitte Ihre Bestellnummer be";
$_LANG["orderfree"] = "Gratis!";
$_LANG["orderfreedomainappliesto"] = "betreffend nur die folgenden Domainendungen (TLD)";
$_LANG["orderfreedomaindescription"] = "zur ausgewählten Zahlungsmethod";
...
$_LANG["ordernewuser"] = "Ich bin ein neuer Kunde und möchte gerne ein Konto eröffn";
$_LANG["ordernoproducts"] = "Keine Produkte gefunden";
$_LANG["ordernotes"] = "Notizen / Zusätzliche Informatio";
$_LANG["ordernotesdescription"] = "Hier können Sie zusätzliche Bemerkungen oder Informationen anführen, die Sie zusammen mit Ihrer Bestellung angeben möchte";
...
$_LANG["orderpaymenttermannually"] = "Jährlic";
...
$_LANG["orderpaymenttermquarterly"] = "Vierteljährlic";
$_LANG["orderpaymenttermsemiannually"] = "Halbjährlic";
...
$_LANG["orderpromoinvalid"] = "Der eingegebene Promotion-Code lässt sich auf keine der Produkte anwende";
...
$_LANG["orderreceived"] = "Vielen Dank für die Bestellung. Sie erhalten in Kürze eine Bestätigung per Ema";
$_LANG["orderregisterdomain"] = "eine neue Domain registrieren";
$_LANG["orderregperiod"] = "Registrierungsperiode";
$_LANG["ordersecure"] = "Ihre Daten werden verschlüsselt übertragen. Zu Ihrer Sicherheit wird Ihre IP-Adres";
$_LANG["ordersecure2"] = "gespeichert.";
$_LANG["orderserverhostname"] = "Server Hostname";
$_LANG["orderservernameservers"] = "DNS Nameserver";
$_LANG["orderservernameserversdescription"] = "Die Prefixe die Sie hier eingeben sind die Nameserver für den Server z.B. ns1.ihredomain.com and ns2.ihredomain.co";
...
$_LANG["ordersetupfee"] = "Aufschaltgebüh";
...
$_LANG["ordertaxstaterequired"] = "Sie müssen ein Bundesland zur Berechnung der MwSt. angebe";
$_LANG["ordertitle"] = "Bestellung";
$_LANG["ordertos"] = "AGB";
$_LANG["ordertosagreement"] = "Ich habe die AGB gelesen und bin damit einverstanden";
$_LANG["ordertotalduetoday"] = "Heute fälliger Gesamtbetra";
...
$_LANG["ordertransfersecret"] = "Transfer-Schlüsse";
$_LANG["ordertransfersecretexplanation"] = "Ein Domain Transfer-Schlüssel (Transfer Secret) muß bei Ihrem aktuellen Domainregistrar beantragt werde";
...
$_LANG["outofstockdescription"] = "Dieser Artikel ist gerade nicht verfügbar. Daher kann Ihre Bestellung für diesen Artikel nicht ausgeführt werden. Für weitere Informationen wenden Sie sich bitte an unseren Supp";
$_LANG["page"] = "Seite";
$_LANG["pageof"] = "von";
$_LANG["please"] = "Bitte";
...
$_LANG["promoexistingclient"] = "Sie müssen ein aktives Produkt / Service haben, um diesen Code zu verwende";
...
$_LANG["recordsfound"] = "Datensätze gefunde";
$_LANG["recurring"] = "Wiederholend";
$_LANG["recurringamount"] = "Betrag für die Verlängerungsperio";
$_LANG["every"] = "Every";
$_LANG["registerdomain"] = "Domainregistrierung";
$_LANG["registerdomaindesc"] = "Geben Sie bitte den zu suchenden Domainnamen an und klicken Sie 'Suchen' um zu prüfen, ob die gewünschte Domain noch frei is";
$_LANG["registerdomainname"] = "Domain registrieren";
$_LANG["relatedservice"] = "Verwandte Services";
$_LANG["rssfeed"] = "Feed";
$_LANG["securityanswerrequired"] = "Sie müssen eine Sicherheitsantwort eingebe";
$_LANG["securitybothnotmatch"] = "Ihre Antwort und Bestätigungsantwort stimmen nicht übere";
$_LANG["securitycurrentincorrect"] = "Ihre derzeitige Frage und Antwort ist nicht korrekt";
$_LANG["serverchangepassword"] = "Passwort änder";
...
$_LANG["serverchangepasswordconfirm"] = "Passwort bestätige";
...
$_LANG["serverstatusdescription"] = "Verfügbarkeit unserer Server prüf";
$_LANG["serverstatusnoservers"] = "Es sind keine Server für die Überwachung registrie";
$_LANG["serverstatusnotavailable"] = "Nicht erhältlic";
...
$_LANG["sslcertapproveremail"] = "Bestätigungskontak";
$_LANG["sslcertapproveremaildetails"] = "Bitte wählen Sie aus den nachstehenden Kontakten einen für die Zusendung der Bestätigungs-Email a";
...
$_LANG["supportticketschoosedepartment"] = "Abteilung auswähle";
...
$_LANG["supportticketsdescription"] = "Hier finden Sie Ihre bereits bestehenden Tickets und können darauf antworte";
...
$_LANG["supportticketsstatuscloseticket"] = "Supportticket schließe";
...
$_LANG["supportticketssystemdescription"] = "Das Supportticketsystem erlaubt uns auf Ihre Probleme und Anfragen möglichst rasch zu reagieren. Wenn wir auf ein Ticket antworten, erhalten Sie zusätzlich eine Nachricht per Emai";
...
$_LANG["telesigninitiatephone"] = "Wir können die Telefonüberprüfung für Ihre Nummer nicht durchführen. Bitte kontaktieren Sie";
$_LANG["telesigninvalidnumber"] = "Ungültige Telefonnumme";
...
$_LANG["telesigninvalidpinmessage"] = "PIN-Code Überprüfung fehlgeschlag";
...
$_LANG["telesignsmstextmessage"] = "Danke, dass Sie unser SMS-Überprüfungssystem verwenden. Ihr Code ist: %s Bitte geben Sie diesen Code nun an Ihrem Computer ei";
$_LANG["telesigntitle"] = "TeleSign Telefonüberprüfun";
$_LANG["telesigntype"] = "Wählen Sie den Überprüfungstyp für die Nummer";
$_LANG["telesignverificationcanceled"] = "Es besteht ein vorübergehendes Problem mit dem Telefonüberprüfungssystem, die Telefonüberprüfung wurde abgebro";
$_LANG["telesignverificationproblem"] = "Es trat ein Problem mit dem Telefonüberprüfungssystem auf und Ihr Auftrag konnte nicht überprüft werden. Bitte versuchen Sie es später wi";
$_LANG["telesignverify"] = "Ihre Telefonnummer %s muss überprüft werden, um den Auftrag abzuschließ";
...
$_LANG["upgradechooseconfigoptions"] = "Optionen für dieses Paket, die Sie upgraden/downgraden möchte";
$_LANG["upgradechoosepackage"] = "Wählen Sie das Hosting-Paket, das Sie upgraden/downgraden möchte";
...
$_LANG["upgradenochange"] = "Keine Änderunge";
$_LANG["upgradeproductlogic"] = "Der Preis für das Upgrade errechnet sich aus dem noch nicht verwendeten Guthaben des laufenden Paketes und dem Preis für das neue Paket für dieselbe Peri";
...
$_LANG["varilogixfraudcall_description"] = "Unser Sicherheitssystem wird nun einen Anruf an die von Ihnen angegebene Telefonnummer tätigen und Sie darum bitten, obigen PIN-Code in Ihre Telefontastatur einzugeben. Bitte klicken Sie hier um den Anruf jetzt auszulöse";
$_LANG["varilogixfraudcall_error"] = "Ein Fehler ist aufgetreten und wir konnten keinen Anruf an Ihre Telefonnummer tätigen. Bitte füllen Sie ein Supportticket aus um Ihre Bestellung manuell überprüfen zu las";
$_LANG["varilogixfraudcall_fail"] = "Der Anruf um Ihre Bestellung zu bestätigen ist leider misslungen. Ein Grund könnte sein, dass die angegebene Telefonnummer ungültig ist oder dass Sie von unserem System in einer schwarzen Liste geführt werden. Bitte füllen Sie ein Supportticket aus um Ihre Bestellung manuell überprüfen zu";
$_LANG["varilogixfraudcall_failed"] = "Misslungen";
$_LANG["varilogixfraudcall_pincode"] = "PIN-Code";
$_LANG["varilogixfraudcall_title"] = "VariLogix Überprüfungsanr";
$_LANG["viewcart"] = "Warenkorb ansehen";
$_LANG["welcomeback"] = "Willkommen zurüc";
$_LANG["whoisresults"] = "WHOIS Results for";
$_LANG["yes"] = "Ja";
$_LANG["yourdetails"] = "Ihre Details";
$_LANG["clientareafiles"] = "Angehängte Dateie";
$_LANG["clientareafilesdate"] = "Hinzugefügt a";
$_LANG["clientareafilesfilename"] = "Dateiname";
$_LANG["pwreset"] = "Passwort-Reset";
$_LANG["pwresetdesc"] = "Wenn Sie ihr Passwort verloren haben, können Sie es hier zurücksetzen. Wenn Sie ihre Email eingeben (und die Geheimfrage beantworten, falls Sie eine haben), erhalten Sie Anweisungen, wie sie ihr Passwort rücksetzen kön";
...
$_LANG["pwresetvalidationsent"] = "Bestätigungs-Email verschick";
$_LANG["pwresetvalidationcheckemail"] = "Die Passwortrücksetzung wurde gestartet. Bitte überprüfen Sie ihre Emails für weitere Anweisun";
$_LANG["pwresetkeyinvalid"] = "Der Rücksetzungslink ist ungültig. Bitte erneut versuche";
$_LANG["pwresetkeyexpired"] = "Der Rücksetzungslink ist abgelaufen. Bitte erneut versuchen";
$_LANG["pwresetvalidationsuccess"] = "Passwortrücksetzung erfolgreic";
$_LANG["pwresetvalidationsuccessdesc"] = "Ihr Passwort wurde zurückgesetzt und die Daten wurden an ihre Email versendet";
$_LANG["overagescharges"] = "Zusatzgebüh";
...
$_LANG["creditcardupdatenotpossible"] = "Kreditkartendetails können nicht verändert werden. Bitte versuchen sie es später erne";
...
$_LANG["clientareanoaddons"] = "Keine Zusatzpakete für diesen Account gefunde";
...
$_LANG["search"] = "Search";
$_LANG["cancel"] = "Cancel";
$_LANG["clientareabacklink"] = "<< Zurüc";
...
$_LANG["addfundsdescription"] = "Sie können Guthaben / Vorauszahlungen zur Zahlung der Rechnungen hinzufügen. Eingezahltes Guthaben ist nicht zurückzahlb";
